...
- Или установить .ipa без отладки через Apple Configurator
- Или попробовать скопировать DeviceSupport iOS 15 в Xcode 16 (не всегда срабатывает)

**Как запустить на iPhone 6s в двух словах:**  
1. Поставь Xcode 15.x рядом с Xcode 16  
2. Открой проект в Xcode 15  
3. iOS Deployment Target = 15.0  
4. Выбери Team в Signing  
5. Подключи 6s, включи на нём Режим разработчика  
6. Выбери устройство и жми Run

**Минимальная iOS:** 15.0  
**Сборка и запуск в Xcode 16:** работает на устройствах с iOS 17+ и в Симуляторе.

Подробная инструкция с картинками будет тут: [docs/BUILD_OLD_IOS.md](docs/BUILD_OLD_IOS.md)
